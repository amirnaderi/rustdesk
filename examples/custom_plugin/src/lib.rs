use libdshelpdesk::api::DsHelpDeskApiTable;
/// This file demonstrates how to write a custom plugin for DsHelpDesk.
...
lazy_static::lazy_static! {
    ...
    // Do your own logic based on the API provided by DsHelpDesk.
    pub static ref API: DsHelpDeskApiTable = DsHelpDeskApiTable::default();
}
