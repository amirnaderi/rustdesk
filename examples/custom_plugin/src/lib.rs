use libdshldesk::api::DshlDeskApiTable;
/// This file demonstrates how to write a custom plugin for DshlDesk.
...
lazy_static::lazy_static! {
    ...
    // Do your own logic based on the API provided by DshlDesk.
    pub static ref API: DshlDeskApiTable = DshlDeskApiTable::default();
}
