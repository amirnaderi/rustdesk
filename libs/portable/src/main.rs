...
const APP_PREFIX: &str = "dshldesk";
const APPNAME_RUNTIME_ENV_KEY: &str = "DSHLDESK_APPNAME";
...
mod windows {
    ...
    pub const WIN_MAG_INJECTED_PROCESS_EXE: &'static str = "RuntimeBroker_dshldesk.exe";
    ...
    pub(super) fn copy_runtime_broker(dir: &PathBuf) {
        ...
        let _allow_err = Command::new("taskkill")
            .args(&["/F", "/IM", "RuntimeBroker_dshldesk.exe"])
