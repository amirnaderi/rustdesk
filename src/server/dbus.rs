...
///
/// Note:
/// On linux, we use dbus to communicate multiple dshelpdesk process.
...
const DBUS_NAME: &str = "org.dshelpdesk.dshelpdesk";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "DsHelpDesk DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.dshelpdesk.dshelpdesk /dbus org.dshelpdesk.dshelpdesk.NewConnection string:'PEER_ID'`
