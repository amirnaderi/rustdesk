...
///
/// Note:
/// On linux, we use dbus to communicate multiple dshldesk process.
...
const DBUS_NAME: &str = "org.dshldesk.dshldesk";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "DshlDesk DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.dshldesk.dshldesk /dbus org.dshldesk.dshldesk.NewConnection string:'PEER_ID'`
