...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "În curs de conectare la rețeaua DshlDesk..."),
        ...
        ("install_tip", "Din cauza restricțiilor CCU, este posibil ca DshlDesk să nu funcționeze corespunzător. Pentru a evita acest lucru, dă clic pe butonul de mai jos pentru a instala DshlDesk."),
        ...
        ("config_acc", "Pentru a controla desktopul la distanță, trebuie să permiți DshlDesk acces la setările de Accesibilitate."),
        ("config_screen", "Pentru a controla desktopul la distanță, trebuie să permiți DshlDesk acces la setările de Înregistrare ecran."),
        ...
        ("android_input_permission_tip1", "Pentru ca un dispozitiv la distanță să poată controla un dispozitiv Android folosind mouse-ul sau suportul tactil, trebuie să permiți DshlDesk să utilize serviciul „Accesibilitate”."),
        ("android_input_permission_tip2", "Accesează următoarea pagină din Setări, deschide [Aplicații instalate] și pornește serviciul [DshlDesk Input]."),
        ...
        ("Language", "Limbă"),
        ("Keep DshlDesk background service", "Rulează serviciul DshlDesk în fundal"),
        ("Ignore Battery Optimizations", "Ignoră optimizările de baterie"),
        ("android_open_battery_optimizations_tip", "Pentru dezactivarea acestei funcții, accesează setările aplicației DshlDesk, deschide secțiunea [Baterie] și deselectează [Fără restricții]."),
        ...
        ("Show DshlDesk", "Afișează DshlDesk"),
        ("This PC", "Acest PC"),
        ("or", "sau"),
        ...
        ("config_input", "Pentru a controla desktopul la distanță folosind tastatura, trebuie să acorzi DshlDesk permisiunea Monitorizare intrare"),
        ("config_microphone", "Pentru a desfășura un apel vocal, este nevoie să acorzi DshlDesk permisiunea Înregistrare audio."),
        ...
        ("still_click_uac_tip", "Este necesar ca utilizatorul la distanță să confirme în fereastra CCU din DshlDesk care rulează."),
        ...
        ("install_cert_tip", "Instalează certificatul DshlDesk"),
        ("confirm_install_cert_tip", "Acesta este un certificat de testare DshlDesk și este de încredere. Certificatul va fi utilizat pentru a acorda încredere și instala drivere DshlDesk atunci când este necesar."),
        ...
        ("verify_dshldesk_password_tip", "Verifică parola DshlDesk"),
        ...
        ("upgrade_dshldesk_server_pro_to_{}_tip", ""),
