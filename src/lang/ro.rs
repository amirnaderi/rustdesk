...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "În curs de conectare la rețeaua DsHelpDesk..."),
        ...
        ("install_tip", "Din cauza restricțiilor CCU, este posibil ca DsHelpDesk să nu funcționeze corespunzător. Pentru a evita acest lucru, dă clic pe butonul de mai jos pentru a instala DsHelpDesk."),
        ...
        ("config_acc", "Pentru a controla desktopul la distanță, trebuie să permiți DsHelpDesk acces la setările de Accesibilitate."),
        ("config_screen", "Pentru a controla desktopul la distanță, trebuie să permiți DsHelpDesk acces la setările de Înregistrare ecran."),
        ...
        ("android_input_permission_tip1", "Pentru ca un dispozitiv la distanță să poată controla un dispozitiv Android folosind mouse-ul sau suportul tactil, trebuie să permiți DsHelpDesk să utilize serviciul „Accesibilitate”."),
        ("android_input_permission_tip2", "Accesează următoarea pagină din Setări, deschide [Aplicații instalate] și pornește serviciul [DsHelpDesk Input]."),
        ...
        ("Language", "Limbă"),
        ("Keep DsHelpDesk background service", "Rulează serviciul DsHelpDesk în fundal"),
        ("Ignore Battery Optimizations", "Ignoră optimizările de baterie"),
        ("android_open_battery_optimizations_tip", "Pentru dezactivarea acestei funcții, accesează setările aplicației DsHelpDesk, deschide secțiunea [Baterie] și deselectează [Fără restricții]."),
        ...
        ("Show DsHelpDesk", "Afișează DsHelpDesk"),
        ("This PC", "Acest PC"),
        ("or", "sau"),
        ...
        ("config_input", "Pentru a controla desktopul la distanță folosind tastatura, trebuie să acorzi DsHelpDesk permisiunea Monitorizare intrare"),
        ("config_microphone", "Pentru a desfășura un apel vocal, este nevoie să acorzi DsHelpDesk permisiunea Înregistrare audio."),
        ...
        ("still_click_uac_tip", "Este necesar ca utilizatorul la distanță să confirme în fereastra CCU din DsHelpDesk care rulează."),
        ...
        ("install_cert_tip", "Instalează certificatul DsHelpDesk"),
        ("confirm_install_cert_tip", "Acesta este un certificat de testare DsHelpDesk și este de încredere. Certificatul va fi utilizat pentru a acorda încredere și instala drivere DsHelpDesk atunci când este necesar."),
        ...
        ("verify_dshelpdesk_password_tip", "Verifică parola DsHelpDesk"),
        ...
        ("upgrade_dshelpdesk_server_pro_to_{}_tip", ""),
