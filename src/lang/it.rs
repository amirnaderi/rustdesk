...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione alla rete DshlDesk..."),
        ...
        ("install_tip", "A causa del controllo account uUtente (UAC), DshlDesk potrebbe non funzionare correttamente come desktop remoto.\nPer evitare questo problema, fai clic sul tasto qui sotto per installare DshlDesk a livello di sistema."),
        ("Click to upgrade", "Aggiorna"),
        ("Click to download", "Download"),
        ("Click to update", "Aggiorna"),
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il desktop dall'esterno, devi fornire a DshlDesk il permesso 'Accessibilità'."),
        ("config_screen", "Per controllare il desktop dall'esterno, devi fornire a DshlDesk il permesso 'Registrazione schermo'."),
        ...
        ("android_input_permission_tip1", "Affinché un dispositivo remoto possa controllare un dispositivo Android tramite mouse o tocco, devi consentire a DshlDesk di usare il servizio 'Accessibilità'."),
        ("android_input_permission_tip2", "Vai nella pagina delle impostazioni di sistema che si aprirà di seguito, trova e accedi a [Servizi installati], attiva il servizio [DshlDesk Input]."),
        ...
        ("Language", "Lingua"),
        ("Keep DshlDesk background service", "Mantieni il servizio di DshlDesk in background"),
        ("Ignore Battery Optimizations", "Ignora le ottimizzazioni della batteria"),
        ("android_open_battery_optimizations_tip", "Se vuoi disabilitare questa funzione, vai nelle impostazioni dell'applicazione DshlDesk, apri la sezione 'Batteria' e deseleziona 'Senza restrizioni'."),
        ...
        ("Show DshlDesk", "Visualizza DshlDesk"),
        ("This PC", "Questo PC"),
        ("or", "O"),
        ...
        ("config_input", "Per controllare il desktop remoto con la tastiera, è necessario concedere le autorizzazioni a DshlDesk 'Monitoraggio input'."),
        ("config_microphone", "Per poter chiamare, è necessario concedere l'autorizzazione 'Registra audio' a DshlDesk."),
        ...
        ("still_click_uac_tip", "Richiedi ancora che l'utente remoto selezioni 'OK' nella finestra UAC dell'esecuzione di DshlDesk."),
        ...
        ("install_cert_tip", "Installa certificato DshlDesk"),
        ("confirm_install_cert_tip", "Questo è un certificato di test DshlDesk, che può essere considerato attendibile.\nIl certificato verrà usato per certificarsi ed installare i driver DshlDesk quando richiesto."),
        ...
        ("verify_dshldesk_password_tip", "Conferma password DshlDesk"),
        ...
        ("scam_text1", "Se sei al telefono con qualcuno che NON conosci NON DI TUA FIDUCIA che ti ha chiesto di usare DshlDesk e di avviare il servizio, non procedere e riattacca subito."),
        ...
        ("upgrade_dshldesk_server_pro_to_{}_tip", "Aggiorna DshlDesk Server Pro alla versione {} o successiva!"),
