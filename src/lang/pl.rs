...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "DsHelpDesk może nie działać poprawnie na maszynie zdalnej z przyczyn związanych z UAC. W celu uniknięcia problemów z UAC, kliknij poniższy przycisk by zainstalować DsHelpDesk w swoim systemie."),
        ...
        ("Discovered", "Wykryte"),
        ("install_daemon_tip", "By uruchomić DsHelpDesk przy starcie systemu, musisz zainstalować usługę systemową."),
        ("Remote ID", "Zdalne ID"),
        ("Paste", "Wklej"),
        ...
        ("android_input_permission_tip1", "Aby można było sterować Twoim urządzeniem za pomocą myszy lub dotyku, musisz zezwolić DsHelpDesk na korzystanie z usługi \"Ułatwienia dostępu\"."),
        ("android_input_permission_tip2", "Przejdź do następnej strony ustawień systemowych, znajdź i wejdź w [Zainstalowane usługi], włącz usługę [DsHelpDesk Input]."),
        ...
        ("Language", "Język"),
        ("Keep DsHelpDesk background service", "Zachowaj usługę DsHelpDesk w tle"),
        ("Ignore Battery Optimizations", "Ignoruj optymalizację baterii"),
        ("android_open_battery_optimizations_tip", "Jeśli chcesz wyłączyć tę funkcję, przejdź do następnej strony ustawień aplikacji DsHelpDesk, znajdź i wprowadź [Bateria], odznacz [Bez ograniczeń]"),
        ...
        ("Show DsHelpDesk", "Pokaż DsHelpDesk"),
        ...
        ("config_input", "By kontrolować zdalne urządzenie przy pomocy klawiatury, musisz udzielić aplikacji DsHelpDesk uprawnień do \"Urządzeń Wejściowych\"."),
        ...
        ("install_cert_tip", "Instalacja certyfikatu DsHelpDesk"),
        ("confirm_install_cert_tip", "To jest certyfikat testowy DsHelpDesk, któremu można zaufać. Certyfikat jest używany do zaufania i instalowania sterowników DsHelpDesk w razie potrzeby."),
        ...
        ("empty_lan_tip", "Ojej, wygląda na to, że nie odkryliśmy żadnych urządzeń z DsHelpDesk w Twojej sieci."),
        ...
        ("verify_dshelpdesk_password_tip", "Weryfikuj hasło DsHelpDesk"),
        ...
        ("scam_text1", "Jeżeli rozmawiasz przez telefon z osobą której NIE ZNASZ i NIE UFASZ, która prosi Cię o uruchomienie programu DsHelpDesk i uruchomienia usługi - nie rób tego i natychmiast się rozłącz."),
        ...
        ("upgrade_dshelpdesk_server_pro_to_{}_tip", "Proszę zaktualizować DsHelpDesk Server Pro do wersji {} lub nowszej!"),
