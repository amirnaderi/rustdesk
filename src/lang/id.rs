...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Menghubungkan ke jaringan DsHelpDesk..."),
        ...
        ("install_tip", "Karena UAC, DsHelpDesk tidak dapat bekerja dengan baik sebagai sisi remote dalam beberapa kasus. Untuk menghindari UAC, silakan klik tombol di bawah ini untuk menginstal DsHelpDesk ke sistem."),
        ("Click to upgrade", "Klik untuk upgrade"),
        ("Click to download", "Klik untuk unduh"),
        ("Click to update", "Klik untuk memperbarui"),
        ("Configure", "Konfigurasi"),
        ("config_acc", "Untuk mengontrol Desktop Anda dari jarak jauh, Anda perlu memberikan izin \"Aksesibilitas\" DsHelpDesk."),
        ("config_screen", "Untuk mengakses Desktop Anda dari jarak jauh, Anda perlu memberikan izin \"Perekaman Layar\" DsHelpDesk."),
        ...
        ("android_input_permission_tip1", "Agar perangkat jarak jauh dapat mengontrol perangkat Android Anda melalui mouse atau sentuhan, Anda harus mengizinkan DsHelpDesk untuk menggunakan layanan \"Aksesibilitas\"."),
        ("android_input_permission_tip2", "Silakan buka halaman pengaturan sistem berikutnya, temukan dan masuk ke [Layanan Terinstal], aktifkan layanan [Input DsHelpDesk]."),
        ...
        ("Language", "Bahasa"),
        ("Keep DsHelpDesk background service", "Pertahankan DsHelpDesk berjalan pada service background"),
        ...
        ("Show DsHelpDesk", "Tampilkan DsHelpDesk"),
        ("This PC", "PC ini"),
        ("or", "atau"),
        ...
        ("config_input", "Untuk menggunakan input keyboard remote, anda perlu memberikan izin \"Pemantauan Input\" pada DsHelpDesk"),
        ("config_microphone", "Untuk berbicara secara remote, anda perlu memberikan izin \"Rekam Audio\" pada DsHelpDesk"),
        ...
        ("still_click_uac_tip", "Masih memerlukan persetujuan pihak pengguna remote untuk mengklik OK pada jendela UAC DsHelpDesk yang sedang berjalan"),
        ...
        ("install_cert_tip", "Install sertifikat DsHelpDesk"),
        ("confirm_install_cert_tip", "Ini adalah sertifikat pengujian DsHelpDesk, yang dapat dipercaya. Sertifikat ini akan digunakan untuk menginstal driver DsHelpDesk saat diperlukan"),
        ...
        ("verify_dshelpdesk_password_tip", "Verifikasi Kata Sandi DsHelpDesk"),
        ...
        ("scam_text1", "Jika Anda sedang berbicara di telepon dengan seseorang yang TIDAK dikenal dan mereka meminta anda untuk menggunakan DsHelpDesk, jangan lanjutkan dan segera tutup panggilan."),
        ...
        ("upgrade_dshelpdesk_server_pro_to_{}_tip", "Silahkan perbarui DsHelpDesk Server Pro ke versi {} atau yang lebih baru!"),
