...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Menghubungkan ke jaringan DshlDesk..."),
        ...
        ("install_tip", "Karena UAC, DshlDesk tidak dapat bekerja dengan baik sebagai sisi remote dalam beberapa kasus. Untuk menghindari UAC, silakan klik tombol di bawah ini untuk menginstal DshlDesk ke sistem."),
        ("Click to upgrade", "Klik untuk upgrade"),
        ("Click to download", "Klik untuk unduh"),
        ("Click to update", "Klik untuk memperbarui"),
        ("Configure", "Konfigurasi"),
        ("config_acc", "Untuk mengontrol Desktop Anda dari jarak jauh, Anda perlu memberikan izin \"Aksesibilitas\" DshlDesk."),
        ("config_screen", "Untuk mengakses Desktop Anda dari jarak jauh, Anda perlu memberikan izin \"Perekaman Layar\" DshlDesk."),
        ...
        ("android_input_permission_tip1", "Agar perangkat jarak jauh dapat mengontrol perangkat Android Anda melalui mouse atau sentuhan, Anda harus mengizinkan DshlDesk untuk menggunakan layanan \"Aksesibilitas\"."),
        ("android_input_permission_tip2", "Silakan buka halaman pengaturan sistem berikutnya, temukan dan masuk ke [Layanan Terinstal], aktifkan layanan [Input DshlDesk]."),
        ...
        ("Language", "Bahasa"),
        ("Keep DshlDesk background service", "Pertahankan DshlDesk berjalan pada service background"),
        ...
        ("Show DshlDesk", "Tampilkan DshlDesk"),
        ("This PC", "PC ini"),
        ("or", "atau"),
        ...
        ("config_input", "Untuk menggunakan input keyboard remote, anda perlu memberikan izin \"Pemantauan Input\" pada DshlDesk"),
        ("config_microphone", "Untuk berbicara secara remote, anda perlu memberikan izin \"Rekam Audio\" pada DshlDesk"),
        ...
        ("still_click_uac_tip", "Masih memerlukan persetujuan pihak pengguna remote untuk mengklik OK pada jendela UAC DshlDesk yang sedang berjalan"),
        ...
        ("install_cert_tip", "Install sertifikat DshlDesk"),
        ("confirm_install_cert_tip", "Ini adalah sertifikat pengujian DshlDesk, yang dapat dipercaya. Sertifikat ini akan digunakan untuk menginstal driver DshlDesk saat diperlukan"),
        ...
        ("verify_dshldesk_password_tip", "Verifikasi Kata Sandi DshlDesk"),
        ...
        ("scam_text1", "Jika Anda sedang berbicara di telepon dengan seseorang yang TIDAK dikenal dan mereka meminta anda untuk menggunakan DshlDesk, jangan lanjutkan dan segera tutup panggilan."),
        ...
        ("upgrade_dshldesk_server_pro_to_{}_tip", "Silahkan perbarui DshlDesk Server Pro ke versi {} atau yang lebih baru!"),
