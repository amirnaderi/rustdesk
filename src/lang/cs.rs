...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Připojování k DsHelpDesk síti..."),
        ...
        ("install_tip", "Kvůli řízení oprávnění v systému (UAC), DsHelpDesk v některých případech na protistraně nefunguje správně. Abyste se UAC vyhnuli, klikněte na níže uvedené tlačítko a nainstalujte tak DsHelpDesk do systému."),
        ("Click to upgrade", "Aktualizovat"),
        ("Click to download", "Stáhnout"),
        ("Click to update", "Aktualizovat"),
        ("Configure", "Nastavit"),
        ("config_acc", "Aby bylo možné na dálku ovládat vaši plochu, je třeba aplikaci DsHelpDesk udělit oprávnění pro \"Zpřístupnění pro hendikepované\"."),
        ("config_screen", "Aby bylo možné přistupovat k vaší ploše na dálku, je třeba aplikaci DsHelpDesk udělit oprávnění pro \"Nahrávání obsahu obrazovky\"."),
        ...
        ("android_input_permission_tip1", "Aby vzdálené zařízení mohlo ovládat vaše Android zařízení prostřednictví myši či dotyků, je třeba povolit, aby DsHelpDesk mohlo používat službu „Zpřístupnění hendikepovaným“."),
        ("android_input_permission_tip2", "Přejděte na následující stránku nastavení systému, najděte a přejděte do [Nainstalované služby] a zapněte službu [DsHelpDesk vstup]."),
        ...
        ("Language", "Jazyk"),
        ("Keep DsHelpDesk background service", "Zachovat službu DsHelpDesk na pozadí"),
        ("Ignore Battery Optimizations", "Ignorovat optimalizaci baterie"),
        ("android_open_battery_optimizations_tip", "Pokud chcete tuto funkci zakázat, přejděte na další stránku nastavení aplikace DsHelpDesk, najděte a zadejte [Baterie], zrušte zaškrtnutí [Neomezeno]."),
        ...
        ("Show DsHelpDesk", "Zobrazit DsHelpDesk"),
        ...
        ("config_input", "Chcete-li ovládat vzdálenou plochu pomocí klávesnice, musíte udělit oprávnění DsHelpDesk \"Sledování vstupu\"."),
        ("config_microphone", "Abyste mohli mluvit na dálku, musíte udělit oprávnění DsHelpDesk \"Nahrávat zvuk\"."),
        ...
        ("still_click_uac_tip", "Stále vyžaduje, aby vzdálený uživatel kliknul na OK v okně UAC spuštěného DsHelpDesku."),
        ...
        ("install_cert_tip", "Instalace certifikátu DsHelpDesk"),
        ("confirm_install_cert_tip", "Jedná se o testovací certifikát DsHelpDesk, kterému lze důvěřovat. Certifikát bude v případě potřeby použit k důvěryhodnosti a instalaci ovladačů DsHelpDesk."),
        ...
        ("verify_dshelpdesk_password_tip", "Ověření hesla DsHelpDesk"),
        ...
        ("scam_text1", "Pokud telefonujete s někým, koho NEZNÁTE a komu NEDŮVĚŘUJETE a kdo vás požádal o použití služby DsHelpDesk a její spuštění, nepokračujte v hovoru a okamžitě zavěste."),
        ...
        ("upgrade_dshelpdesk_server_pro_to_{}_tip", "Aktualizujte prosím DsHelpDesk Server Pro na verzi {} nebo novější!"),
