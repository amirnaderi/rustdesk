...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Kullanıcı Hesabı Denetimi nedeniyle, DsHelpDesk bir uzak masaüstü olarak düzgün çalışmayabilir. Bu sorunu önlemek için, DsHelpDesk'i sistem seviyesinde kurmak için aşağıdaki butona tıklayın."),
        ...
        ("Configure", "Ayarla"),
        ("config_acc", "Masaüstünüzü dışarıdan kontrol etmek için DsHelpDesk'e \"Erişilebilirlik\""),
        ("config_screen", "Masaüstünüzü dışarıdan kontrol etmek için DsHelpDesk'e \"Ekran Kaydı\" iznini vermeniz gerekir."),
        ...
        ("android_input_permission_tip1", "Uzak bir cihazın Android cihazınızı fare veya dokunma yoluyla kontrol edebilmesi için, DsHelpDesk'in \"Erişilebilirlik\" özelliğini kullanmasına izin vermelisiniz."),
        ("android_input_permission_tip2", "Sonraki sistem ayarları sayfasına gidin, [Yüklü Hizmetler]'i bulun ve erişin, [DsHelpDesk Girişi] hizmetini etkinleştirin."),
        ...
        ("Language", "Dil"),
        ("Keep DsHelpDesk background service", "DsHelpDesk arka plan hizmetini sürdürün"),
        ...
        ("Show DsHelpDesk", "DsHelpDesk'i Göster"),
        ("This PC", "Bu PC"),
        ("or", "veya"),
        ...
        ("config_input", "Uzaktaki masaüstünü klavye ile kontrol etmek için DsHelpDesk'e \"Giriş İzleme\" izinleri vermelisiniz."),
        ("config_microphone", "Uzaktan konuşmak için DsHelpDesk'e \"Ses Kaydı\" izinleri vermelisiniz."),
        ...
        ("still_click_uac_tip", "Uzaktaki kullanıcının çalışan DsHelpDesk'in UAC penceresinde hala Tamam'ı tıklaması gerekmektedir."),
        ...
        ("install_cert_tip", "DsHelpDesk sertifikasını yükleyin"),
        ("confirm_install_cert_tip", "Bu, güvenilir olabilecek bir DsHelpDesk test sertifikasıdır. Sertifika, gerekli olduğunda DsHelpDesk sürücülerini güvenilir ve yüklemek üzere kullanacaktır."),
        ...
        ("verify_dshelpdesk_password_tip", "DsHelpDesk parolasını doğrulayın"),
