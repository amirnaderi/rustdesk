...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till DsHelpDesk..."),
        ...
        ("install_tip", "På grund av UAC, kan inte DsHelpDesk fungera ordentligt på klientsidan. För att undvika problem med UAC, tryck på knappen nedan för att installera DsHelpDesk på systemet."),
        ...
        ("config_acc", "För att kontrollera din dator på distans måste du ge DsHelpDesk \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge DsHelpDesk \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [DsHelpDesk Input] tjänsten."),
        ...
        ("Language", "Språk"),
        ("Keep DsHelpDesk background service", "Behåll DsHelpDesk i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa DsHelpDesk programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ("Start on Boot", ""),
        ...
        ("Show DsHelpDesk", "Visa DsHelpDesk"),
        ("This PC", "Denna dator"),
        ("or", "eller"),
