...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the DshlDesk network..."),
        ...
        ("install_tip", "Due to UAC, DshlDesk can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install DshlDesk to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant DshlDesk \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant DshlDesk \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow DshlDesk to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [DshlDesk Input] service."),
        ...
        ("doc_mac_permission", "https://dshldesk.com/docs/en/manual/mac/#enable-permissions"),
        ("Ignore Battery Optimizations", "Ignore battery optimizations"),
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next DshlDesk application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant DshlDesk \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant DshlDesk \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running DshlDesk."),
        ...
        ("install_cert_tip", "Install DshlDesk certificate"),
        ("confirm_install_cert_tip", "This is a DshlDesk testing certificate, which can be trusted. The certificate will be used to trust and install DshlDesk drivers when required."),
        ...
        ("verify_dshldesk_password_tip", "Verify DshlDesk password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use DshlDesk and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_dshldesk_server_pro_to_{}_tip", "Please upgrade DshlDesk Server Pro to version {} or newer!"),
        ("pull_group_failed_tip", "Failed to refresh group"),
        ("doc_fix_wayland", "https://dshldesk.com/docs/en/manual/linux/#x11-required"),
    ].iter().cloned().collect();
}
