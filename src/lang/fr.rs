...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Prêt"),
        ("Established", "Établi"),
        ("connecting_status", "Connexion au réseau DshlDesk..."),
        ...
        ("config_acc", "Afin de pouvoir contrôler votre bureau à distance, veuillez donner l'autorisation \"accessibilité\" à DshlDesk."),
        ("config_screen", "Afin de pouvoir accéder à votre bureau à distance, veuillez donner à DshlDesk l'autorisation \"enregistrement d'écran\"."),
        ...
        ("android_input_permission_tip1", "Pour qu'un appareil distant puisse contrôler votre appareil Android via la souris ou le toucher, vous devez autoriser DshlDesk à utiliser le service \"Accessibilité\"."),
        ("android_input_permission_tip2", "Veuillez accéder à la page suivante des paramètres système, recherchez et entrez [Services installés], activez le service [DshlDesk Input]."),
        ...
        ("Language", "Langue"),
        ("Keep DshlDesk background service", "Gardez le service DshlDesk en arrière plan"),
        ...
        ("Show DshlDesk", "Afficher DshlDesk"),
        ("This PC", "Ce PC"),
        ("or", "ou"),
        ...
        ("config_input", "Afin de contrôler le bureau à distance avec le clavier, vous devez accorder à DshlDesk l'autorisation \"Surveillance de l’entrée\"."),
        ("config_microphone", "Pour discuter à distance, vous devez accorder à DshlDesk les autorisations « Enregistrer l'audio »."),
        ...
        ("still_click_uac_tip", "Nécessite toujours que l'utilisateur distant confirme par la fenêtre UAC de DshlDesk en cours d'éxécution."),
        ...
        ("install_cert_tip", "Installer le certificat DshlDesk"),
        ("confirm_install_cert_tip", "Il s'agit d'un certificat DshlDesk, auquel on peut faire confiance. Le certificat sera utilisé pour approuver et installer les pilotes DshlDesk si nécessaire."),
        ...
        ("verify_dshldesk_password_tip", "Vérifier le mot de passe DshlDesk"),
        ...
        ("scam_text1", "Si vous êtes au téléphone avec quelqu'un QUE VOUS NE CONNAISSEZ PAS et en qui VOUS N'AVEZ PAS CONFIANCE et qui vous a demandé d'utiliser DshlDesk et de démarrer le service, ne le faites pas et raccrochez immédiatement."),
        ...
        ("upgrade_dshldesk_server_pro_to_{}_tip", "Veuillez mettre à jour DshlDesk Server Pro avec la version {} ou une version plus récente !"),
