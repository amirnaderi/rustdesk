...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Prêt"),
        ("Established", "Établi"),
        ("connecting_status", "Connexion au réseau DsHelpDesk..."),
        ...
        ("config_acc", "Afin de pouvoir contrôler votre bureau à distance, veuillez donner l'autorisation \"accessibilité\" à DsHelpDesk."),
        ("config_screen", "Afin de pouvoir accéder à votre bureau à distance, veuillez donner à DsHelpDesk l'autorisation \"enregistrement d'écran\"."),
        ...
        ("android_input_permission_tip1", "Pour qu'un appareil distant puisse contrôler votre appareil Android via la souris ou le toucher, vous devez autoriser DsHelpDesk à utiliser le service \"Accessibilité\"."),
        ("android_input_permission_tip2", "Veuillez accéder à la page suivante des paramètres système, recherchez et entrez [Services installés], activez le service [DsHelpDesk Input]."),
        ...
        ("Language", "Langue"),
        ("Keep DsHelpDesk background service", "Gardez le service DsHelpDesk en arrière plan"),
        ...
        ("Show DsHelpDesk", "Afficher DsHelpDesk"),
        ("This PC", "Ce PC"),
        ("or", "ou"),
        ...
        ("config_input", "Afin de contrôler le bureau à distance avec le clavier, vous devez accorder à DsHelpDesk l'autorisation \"Surveillance de l’entrée\"."),
        ("config_microphone", "Pour discuter à distance, vous devez accorder à DsHelpDesk les autorisations « Enregistrer l'audio »."),
        ...
        ("still_click_uac_tip", "Nécessite toujours que l'utilisateur distant confirme par la fenêtre UAC de DsHelpDesk en cours d'éxécution."),
        ...
        ("install_cert_tip", "Installer le certificat DsHelpDesk"),
        ("confirm_install_cert_tip", "Il s'agit d'un certificat DsHelpDesk, auquel on peut faire confiance. Le certificat sera utilisé pour approuver et installer les pilotes DsHelpDesk si nécessaire."),
        ...
        ("verify_dshelpdesk_password_tip", "Vérifier le mot de passe DsHelpDesk"),
        ...
        ("scam_text1", "Si vous êtes au téléphone avec quelqu'un QUE VOUS NE CONNAISSEZ PAS et en qui VOUS N'AVEZ PAS CONFIANCE et qui vous a demandé d'utiliser DsHelpDesk et de démarrer le service, ne le faites pas et raccrochez immédiatement."),
        ...
        ("upgrade_dshelpdesk_server_pro_to_{}_tip", "Veuillez mettre à jour DsHelpDesk Server Pro avec la version {} ou une version plus récente !"),
